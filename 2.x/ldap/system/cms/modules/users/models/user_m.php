...
class User_m extends MY_Model
{
	...
	//Update password from LDAP, in event LDAP fails
	public function update_password_from_ldap($id, $password){
			$data = array(
               'password' => $password,
            );
	...
	// Manual / force activation to support integration with other auths
	public function activate_manual($id){
		$data = array(
               'active' => '1',
            );
